...
import { Mail, Search, Trash2, AlertTriangle, X, MessageSquare, Calendar, User, Phone } from 'lucide-react'; // 👈 Eye icon එක අයින් කරා
          ...
          <div className="overflow-x-auto max-h-[450px] overflow-y-auto"> 
            <table className="w-full text-left border-collapse sticky-header">
              ...
              <tbody className="divide-y divide-gray-50 text-sm text-gray-700">
                ...
                {messages.length === 0 && (
                  <tr>
                    <td colSpan="6" className="text-center py-10 text-gray-400 text-sm">No messages found.</td>
                  </tr>
                )}
              </tbody>
            </table>
